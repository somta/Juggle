...
class DateParserTest {
    ...
    void genExpression() {
        ...
        unknownConditionExpression.setDataType(DataTypeEnum.Date);
    ...
    private void dateEqualParserTest() {
        ...
        equalConditionExpression.setDataType(DataTypeEnum.Date);
    ...
    private void dateNotEqualParserTest() {
        ...
        notEqualConditionExpression.setDataType(DataTypeEnum.Date);
    ...
    private void dateGtParserTest() {
        ...
        gtConditionExpression.setDataType(DataTypeEnum.Date);
