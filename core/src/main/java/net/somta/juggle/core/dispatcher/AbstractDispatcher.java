...
import net.somta.juggle.core.model.node.EndEventNode;
import net.somta.juggle.core.model.node.MethodNode;
import net.somta.juggle.core.model.node.StartEventNode;
...
public abstract class AbstractDispatcher implements IDispatcher {
    ...
    private Map<String, FlowElement> buildFlowElementMap(String content){
        ...
        //开始节点
        StartEventNode startEventNode = new StartEventNode();
        ...
        //结束节点
        EndEventNode endEventNode = new EndEventNode();
