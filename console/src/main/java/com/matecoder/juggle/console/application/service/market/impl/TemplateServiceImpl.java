package com.matecoder.juggle.console.application.service.market.impl;
...
import com.matecoder.juggle.console.application.assembler.market.ITemplateAssembler;
import com.matecoder.juggle.console.application.service.flow.IFlowDefinitionService;
import com.matecoder.juggle.console.application.service.market.ITemplateService;
...
import com.matecoder.juggle.console.domain.template.repository.ITemplateRepository;
...
import com.matecoder.juggle.console.interfaces.param.market.TemplateMarketParam;
import com.matecoder.juggle.console.interfaces.param.market.TemplateMarketQueryParam;
...
import static com.matecoder.juggle.console.domain.template.enums.TemplateErrorEnum.TEMPLATE_NOT_EXIST_ERROR;
...
public class TemplateServiceImpl implements ITemplateService {
    ...
    public Boolean useTemplateMarket(TemplateMarketParam templateMarketParam) {
        ...
        if(StringUtils.isNotEmpty(templateMarketInfoVo.getFlowInputParams())){
            ...
            try {
                flowInputParamList = JsonUtil.deserialize(templateMarketInfoVo.getFlowInputParams(), List.class, InputParameterVO.class);
        ...
        if(StringUtils.isNotEmpty(templateMarketInfoVo.getFlowOutputParams())){
            ...
            try {
                flowOutputParamList = JsonUtil.deserialize(templateMarketInfoVo.getFlowOutputParams(), List.class, OutputParameterVO.class);
            } catch (JsonProcessingException e) {
                throw new RuntimeException(e);
            }
        ...
        if(StringUtils.isNotBlank(templateMarketInfoVo.getFlowVariables())){
            try {
                List<VariableInfoVO> variableInfoList = JsonUtil.deserialize(templateMarketInfoVo.getFlowVariables(),List.class,VariableInfoVO.class);
