package com.matecoder.juggle.console.domain.flow.definition;
...
import com.matecoder.juggle.core.enums.ElementTypeEnum;
import com.matecoder.juggle.core.expression.ExpressionManager;
import com.matecoder.juggle.core.model.FlowElement;
import com.matecoder.juggle.core.model.Variable;
import com.matecoder.juggle.core.model.node.ConditionNode;
import com.matecoder.juggle.core.model.node.ConditionNode.*;
import com.matecoder.juggle.core.model.node.EndNode;
import com.matecoder.juggle.core.model.node.StartNode;
...
public class FlowDefinitionAO {
    ...
    public void initDefaultFlowContent(String flowName) {
        ...
        try {
            this.flowContent = JsonUtil.serialize(elementList);
    ...
    public void processFlowContent() throws JsonProcessingException {
        List<FlowElement> elementList = JsonUtil.deserialize(this.flowContent,List.class,FlowElement.class);
        elementList.stream()
