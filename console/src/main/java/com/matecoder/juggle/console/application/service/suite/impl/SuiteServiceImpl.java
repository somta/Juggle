...
import com.matecoder.juggle.console.application.assembler.suite.ISuiteAssembler;
import com.matecoder.juggle.console.application.service.IObjectService;
import com.matecoder.juggle.console.application.service.suite.IApiService;
import com.matecoder.juggle.console.application.service.suite.ISuiteService;
...
import com.matecoder.juggle.console.domain.suite.suiteinfo.vo.*;
...
public class SuiteServiceImpl implements ISuiteService {
    ...
    private void addSuiteObjectList(String objectListStr) {
        if(StringUtils.isNotBlank(objectListStr)){
            ...
            try {
                objectList = JsonUtil.deserialize(objectListStr, List.class, ObjectAddParam.class);
