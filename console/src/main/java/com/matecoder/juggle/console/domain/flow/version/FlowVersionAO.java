package com.matecoder.juggle.console.domain.flow.version;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.matecoder.common.utils.JsonUtil;
import com.matecoder.juggle.console.domain.flow.version.enums.FlowVersionStatusEnum;
import com.matecoder.juggle.core.model.InputParameter;
import com.matecoder.juggle.core.model.OutputParameter;
...
public class FlowVersionAO {
    ...
    public List<InputParameter> getFlowRuntimeInputParameters() {
        ...
        try {
            if(StringUtils.isNotBlank(this.inputs)){
                inputParameterList = JsonUtil.deserialize(this.inputs, List.class, InputParameter.class);
            }
    ...
    public List<OutputParameter> getFlowRuntimeOutputParameters() {
        ...
        try {
            outputParameterList = JsonUtil.deserialize(this.outputs, List.class, OutputParameter.class);
        } catch (JsonProcessingException e) {
            throw new RuntimeException(e);
        }
    ...
    public List<Variable> getFlowRuntimeVariables() {
        ...
        try {
            variableList = JsonUtil.deserialize(this.variables, List.class, Variable.class);
        } catch (JsonProcessingException e) {
            throw new RuntimeException(e);
        }
        return variableList;
